...
function renderLink(
  ...
  if (link.url === "#contact-form") {
    return (
      <div className="rounded-2xl border bg-card/80 p-4 shadow-card backdrop-blur-sm">
  ...
  return (
    ...
    >
      ...
      <div className="relative px-5">
        ...
        <div className="mt-3">
          <h1 className="text-2xl font-bold tracking-tight">{profile.title || profile.slug}</h1>
          {profile.bio && (
              ...
              {profile.products.map((product) => (
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <p className="mt-1 text-xs opacity-70">{product.description}</p>
        ...
        <div className="mt-12 flex items-center justify-center gap-4 text-xs opacity-50">
          ...
          <span>·</span>
          <Link href="/" className="hover:opacity-100">Powered by Linkfree</Link>
        </div>
      </div>
    </motion.div>
  )
